...
from .de_utils import EAresult, random_population, get_experiments_file, random_indexes
from .solution import Solution

import math

def shade(fun, run_info, dimension, check_evals, name_output=None, replace=True, popsize=100, H=100, population=None, population_fitness=None, initial_solution=None, MemF=None, MemCR=None):
    """
...
def shade_v2(solution, check_evals, name_output=None, replace=True, popsize=100, H=100, population=None, population_fitness=None, initial_solution=None, MemF=None, MemCR=None):
    """
    It applies the DE elements.
    ...
    if population_fitness is None:
        population_fitness = np.array([solution.fitness(ind) for ind in population])
        currentEval = popsize
    else:
        currentEval = 0
    ...
    while currentEval < maxEval:
        ...
        weights = []
        for i, fitness in enumerate(population_fitness):
            fitness_u = solution.fitness(u[i])
